...
export function getEvents() {
  const raw = [
    { slug: "zomerpicknick-verleden", offset: -4, time: "12:30", end: "16:00", title: "Zomerpicknick bij de vijver", location: "Plan d’eau, Apt", summary: "Afgelopen verenigingspicknick. Dit event staat bewust in het verleden om filtering door de NieuwsbriefAssistent te testen." },
    ...
    { slug: "petanque-gordes", offset: 5, time: "15:00", end: "17:30", title: "Geannuleerd – Pétanque in Gordes", location: "Terrain municipal, Gordes", summary: "Deze activiteit is geannuleerd. Dit event blijft bewust in de feed staan om de NieuwsbriefAssistent te testen.", cancelled: true },
...
export function getPosts() {
  ...
  return raw
    .map((post) => ({ ...post, date: dateFromOffset(post.offset), dateLabel: formatDate(post.offset) }))
