...
export function getEvents() {
  const raw = [
    ...
    { slug: "petanque-gordes", offset: 5, time: "15:00", end: "17:30", title: "Geannuleerd – Pétanque in Gordes", location: "Terrain municipal, Gordes", summary: "Deze activiteit is geannuleerd. Dit event blijft bewust in de feed staan om de NieuwsbriefAssistent te testen." },
